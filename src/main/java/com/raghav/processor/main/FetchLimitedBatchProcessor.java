...
public class FetchLimitedBatchProcessor extends AbstractProcessor{
    private final int batchSize;

    public FetchLimitedBatchProcessor(int batchSize) {
    ...
    private String getQuery(){
        return "select * from article order by id limit ? ";
    }
}
